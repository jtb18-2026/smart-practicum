...
/* ═══════════════════════════════════════════
   ...
   Text:      #e6edf3  (off-white — easy on eyes)
   Muted:     #8b949e  (grey)
   Accent:    #a78bfa  (soft violet — professional)
   Green:     #3fb950  (emerald — strong match)
   Orange:    #d29922  (amber — partial match)
   Red:       #f85149  (coral red — weak match)
═══════════════════════════════════════════ */
