...
.stButton > button {
    background: linear-gradient(135deg, #0a2540, #1a56db) !important;
...
.stButton > button:hover {
    background: linear-gradient(135deg, #0f3460, #2563eb) !important;
    transform: translateY(-1px) !important;
    box-shadow: 0 8px 20px rgba(26,86,219,0.28) !important;
}
.sidebar-section {
    background: #f8fafc;
    border-radius: 10px;
