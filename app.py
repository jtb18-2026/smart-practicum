...
/* Streamlit's block/page container */
.block-container,
...
/* Text area label */
[data-testid="stTextArea"] label { color: #f1f5f9 !important; }
...
/* ── Hero Banner ── */
.hero-banner {
    background: linear-gradient(135deg, #0c1a3a 0%, #0e4272 50%, #065f8a 100%);
...
.match-card:hover {
    ...
    box-shadow: 0 6px 32px rgba(56,189,248,0.15);
}
.match-rank {
    font-family: 'Space Grotesk', sans-serif;
    font-size: 0.88rem;
...
.stButton > button:hover {
    ...
    box-shadow: 0 10px 28px rgba(56,189,248,0.35) !important;
}
.sidebar-section {
    background: #131f35;
    border-radius: 12px;
...
with st.sidebar:
    ...
    <div style='text-align:center; padding: 1.2rem 0 1.8rem 0;'>
        <div style='font-family: Space Grotesk, sans-serif; font-size: 1.6rem;
                    font-weight: 700; color: #ffffff; letter-spacing:-0.01em;'>Smart Practicum</div>
    ...
    <div class='sidebar-section'>
        <div style='color:#38bdf8; font-size:0.8rem;
                    text-transform:uppercase; letter-spacing:0.12em;
                    margin-bottom:0.6rem; font-weight:700;'>Data</div>
        <div style='color:#e2e8f0; font-size:0.9rem; line-height:1.9;'>
            ...
            for rank, j_idx in enumerate(top_k_idx, start=1):
                ...
                <div class='match-card'>
                    ...
                    <div style='display:grid; grid-template-columns:1fr 1fr 1fr;
                        ...
                        <div style='background:#0a0f1e; border:1px solid rgba(56,189,248,0.2);
                                    border-radius:10px; padding:0.75rem; text-align:center;'>
                            <div style='color:#38bdf8; font-size:1.3rem;
...
# ══════════════════════════════════════════════════════════════════════════
    ...
    with col1:
        ...
        fig.update_layout(
            ...
            font_color='#e2e8f0', font_size=14, height=340,
            xaxis=dict(gridcolor='#1e3a5f', color='#e2e8f0'),
    ...
    if all_skills:
        ...
        fig.update_layout(
            paper_bgcolor='#111827', plot_bgcolor='#0a0f1e',
            font_color='#e2e8f0', font_size=14, height=450,
            yaxis={'autorange':'reversed', 'color':'#e2e8f0'},
    ...
    if 'Resume_Category' in top1.columns:
        ...
        fig.update_layout(
            paper_bgcolor='#111827', plot_bgcolor='#0a0f1e',
            font_color='#e2e8f0', font_size=14, height=420,
            xaxis_tickangle=-40, xaxis=dict(color='#e2e8f0'),
            coloraxis_showscale=False,
            yaxis=dict(gridcolor='#1e3a5f', color='#e2e8f0'),
            title_font_size=18, title_font_color='#ffffff'
        )
...
# ══════════════════════════════════════════════════════════════════════════
    ...
    for title, desc in steps:
        ...
        <div class='match-card'>
            <div style='font-family:Space Grotesk,sans-serif; font-weight:700;
                        color:#38bdf8; font-size:1.2rem; margin-bottom:0.6rem;'>
                {title}
            </div>
            <div style='color:#e2e8f0; font-size:1.05rem; line-height:1.9;
    ...
    st.markdown("""
    <div class='info-box'>
        <table style='width:100%; border-collapse:collapse; color:#e2e8f0; font-size:1.05rem;'>
            <tr style='border-bottom:2px solid rgba(56,189,248,0.3);'>
                <th style='padding:0.9rem 0.6rem; text-align:left; color:#38bdf8; font-size:1.1rem;'>Component</th>
                <th style='padding:0.9rem 0.6rem; text-align:center; color:#38bdf8; font-size:1.1rem;'>Weight</th>
                <th style='padding:0.9rem 0.6rem; text-align:left; color:#38bdf8; font-size:1.1rem;'>What it measures</th>
            </tr>
            <tr style='border-bottom:1px solid rgba(56,189,248,0.1);'>
                <td style='padding:0.9rem 0.6rem; color:#f1f5f9;'>Skill Overlap</td>
                <td style='padding:0.9rem 0.6rem; text-align:center; color:#4ade80; font-weight:700; font-size:1.2rem;'>40%</td>
                <td style='padding:0.9rem 0.6rem;'>Fraction of job's required skills found in your resume</td>
            </tr>
            <tr style='border-bottom:1px solid rgba(56,189,248,0.1);'>
                <td style='padding:0.9rem 0.6rem; color:#f1f5f9;'>Education Match</td>
                <td style='padding:0.9rem 0.6rem; text-align:center; color:#38bdf8; font-weight:700; font-size:1.2rem;'>20%</td>
                <td style='padding:0.9rem 0.6rem;'>Your education level vs job requirement</td>
            </tr>
            <tr style='border-bottom:1px solid rgba(56,189,248,0.1);'>
                <td style='padding:0.9rem 0.6rem; color:#f1f5f9;'>Experience Match</td>
                <td style='padding:0.9rem 0.6rem; text-align:center; color:#38bdf8; font-weight:700; font-size:1.2rem;'>20%</td>
                <td style='padding:0.9rem 0.6rem;'>Entry / Mid / Senior level alignment</td>
            </tr>
            <tr>
                <td style='padding:0.9rem 0.6rem; color:#f1f5f9;'>Cosine Similarity</td>
                <td style='padding:0.9rem 0.6rem; text-align:center; color:#38bdf8; font-weight:700; font-size:1.2rem;'>20%</td>
