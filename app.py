...
.match-card:hover {
    ...
    box-shadow: 0 4px 28px rgba(96,165,250,0.12);
}
.match-rank {
    font-family: 'Space Grotesk', sans-serif;
    font-size: 0.9rem;
...
.stButton > button:hover {
    ...
    box-shadow: 0 10px 28px rgba(96,165,250,0.35) !important;
}
.sidebar-section {
    background: #1e293b;
    border-radius: 12px;
...
with st.sidebar:
    ...
    <div style='text-align:center; padding: 1.2rem 0 1.8rem 0;'>
        <div style='font-family: Space Grotesk, sans-serif; font-size: 1.6rem;
                    font-weight: 700; color: #f1f5f9; letter-spacing:-0.01em;'>Smart Practicum</div>
        <div style='color: #60a5fa; font-size: 0.82rem;
    ...
    <div class='sidebar-section'>
        <div style='color:#60a5fa; font-size:0.8rem;
                    ...
                    margin-bottom:0.6rem; font-weight:600;'>Data</div>
    ...
    <div class='sidebar-section'>
        <div style='color:#60a5fa; font-size:0.8rem;
                    text-transform:uppercase; letter-spacing:0.1em;
                    margin-bottom:0.6rem; font-weight:600;'>Model</div>
        <div style='color:#cbd5e1; font-size:0.9rem; line-height:1.8;'>
            🤖 all-MiniLM-L6-v2<br>
...
<div class='hero-banner'>
    ...
    <p style='color:#cbd5e1; margin:0.6rem 0 0 0; font-size:1.15rem; line-height:1.6; max-width:700px;'>
                ...
                <div class='match-card'>
                    ...
                    <div style='display:grid; grid-template-columns:1fr 1fr 1fr;
                        ...
                        <div style='background:#0f172a; border-radius:10px;
                            ...
                            <div style='color:#60a5fa; font-size:1.2rem;
...
# ══════════════════════════════════════════════════════════════════════════
    ...
    with col1:
        ...
        fig.update_layout(
            paper_bgcolor='#1e293b', plot_bgcolor='#0d1117',
            font_color='#cbd5e1', font_size=14, height=340,
            xaxis=dict(gridcolor='#334155'),
            yaxis=dict(gridcolor='#334155'),
            title_font_size=18, title_font_color='#f1f5f9'
        )
    ...
    with col2:
        ...
        fig = px.pie(values=list(quality.values()),
                     ...
                     color_discrete_sequence=['#4ade80','#fb923c','#f87171'],
                     title='Match Quality Breakdown')
        fig.update_layout(
            paper_bgcolor='#1e293b', font_color='#cbd5e1',
    ...
    if all_skills:
        ...
        fig.update_layout(
            paper_bgcolor='#1e293b', plot_bgcolor='#0d1117',
            font_color='#cbd5e1', font_size=14, height=450,
    ...
    if 'Resume_Category' in top1.columns:
        ...
        fig.update_layout(
            paper_bgcolor='#1e293b', plot_bgcolor='#0d1117',
            font_color='#cbd5e1', font_size=14, height=420,
            xaxis_tickangle=-40,
            coloraxis_showscale=False,
            yaxis=dict(gridcolor='#334155'),
            title_font_size=18, title_font_color='#f1f5f9'
...
# ══════════════════════════════════════════════════════════════════════════
    ...
    for title, desc in steps:
        ...
        <div class='match-card'>
            <div style='font-family:Space Grotesk,sans-serif; font-weight:700;
                        color:#60a5fa; font-size:1.15rem; margin-bottom:0.6rem;'>
                {title}
            </div>
    ...
    st.markdown("""
    <div class='info-box'>
        <table style='width:100%; border-collapse:collapse; color:#cbd5e1; font-size:1rem;'>
            <tr style='border-bottom:1px solid #334155;'>
                <th style='padding:0.75rem 0.5rem; text-align:left; color:#60a5fa; font-size:1.05rem;'>Component</th>
                <th style='padding:0.75rem 0.5rem; text-align:center; color:#60a5fa; font-size:1.05rem;'>Weight</th>
                <th style='padding:0.75rem 0.5rem; text-align:left; color:#60a5fa; font-size:1.05rem;'>What it measures</th>
            </tr>
            <tr style='border-bottom:1px solid #1e293b;'>
                <td style='padding:0.75rem 0.5rem;'>Skill Overlap</td>
                <td style='padding:0.75rem 0.5rem; text-align:center; color:#4ade80; font-weight:700; font-size:1.1rem;'>40%</td>
                <td style='padding:0.75rem 0.5rem;'>Fraction of job's required skills found in your resume</td>
            </tr>
            <tr style='border-bottom:1px solid #1e293b;'>
                <td style='padding:0.75rem 0.5rem;'>Education Match</td>
                <td style='padding:0.75rem 0.5rem; text-align:center; color:#60a5fa; font-weight:700; font-size:1.1rem;'>20%</td>
                <td style='padding:0.75rem 0.5rem;'>Your education level vs job requirement</td>
            </tr>
            <tr style='border-bottom:1px solid #1e293b;'>
                <td style='padding:0.75rem 0.5rem;'>Experience Match</td>
                <td style='padding:0.75rem 0.5rem; text-align:center; color:#60a5fa; font-weight:700; font-size:1.1rem;'>20%</td>
                <td style='padding:0.75rem 0.5rem;'>Entry / Mid / Senior level alignment</td>
            </tr>
            <tr>
                <td style='padding:0.75rem 0.5rem;'>Cosine Similarity</td>
                <td style='padding:0.75rem 0.5rem; text-align:center; color:#60a5fa; font-weight:700; font-size:1.1rem;'>20%</td>
                <td style='padding:0.75rem 0.5rem;'>Semantic meaning match via BERT embeddings</td>
            </tr>
        </table>
    </div>
    """, unsafe_allow_html=True)
