...
/* ═══════════════════════════════════════
   LIGHT THEME PALETTE
   Page BG:    #f1f5f9  (light slate)
   Card BG:    #ffffff  (white)
   Sidebar:    #f8fafc
   Border:     #e2e8f0
   Primary:    #4f46e5  (indigo — buttons, accents)
   Secondary:  #0891b2  (cyan — company names, links)
   Text:       #0f172a  (near black)
   Muted:      #64748b  (slate grey)
   Green:      #16a34a  (strong match)
   Amber:      #d97706  (partial match)
   Red:        #dc2626  (weak match)
═══════════════════════════════════════ */
...
p, span, div, label, li, td, th { color: #0f172a; }
...
[data-testid="stRadio"] label, [data-testid="stRadio"] div { color: #0f172a !important; }
[data-testid="stSlider"] label, [data-testid="stSlider"] div { color: #0f172a !important; }
[data-testid="stTextArea"] label { color: #0f172a !important; }
[data-testid="stMultiSelect"] label { color: #0f172a !important; }
[data-testid="stSelectbox"] label { color: #0f172a !important; }
...
.job-link-btn:hover { background: #4338ca; }
.badge {
    display: inline-block;
...
with st.sidebar:
    ...
    <div style='text-align:center; padding:1rem 0 1.5rem 0;'>
        <div style='font-family:Space Grotesk,sans-serif; font-size:1.5rem;
                    font-weight:700; color:#0f172a;'>Smart Practicum</div>
        <div style='color:#4f46e5; font-size:0.78rem; text-transform:uppercase;
    ...
    <div class='sidebar-section'>
        <div style='color:#4f46e5; font-size:0.75rem; text-transform:uppercase;
                    letter-spacing:0.1em; margin-bottom:0.5rem; font-weight:700;'>Data</div>
        <div style='color:#475569; font-size:0.85rem; line-height:1.8;'>
            ✅ 124k+ LinkedIn jobs<br>
            ✅ Auto-loaded on startup<br>
            <span style='color:#94a3b8; font-size:0.78rem;'>No setup needed</span>
        </div>
    </div>
    <div class='sidebar-section'>
        <div style='color:#4f46e5; font-size:0.75rem; text-transform:uppercase;
                ...
                <div class='match-card'>
                    ...
                    <div style='display:grid; grid-template-columns:1fr 1fr 1fr; gap:0.5rem; margin:0.8rem 0;'>
                        <div style='background:#f8fafc; border:1px solid #e2e8f0; border-radius:8px;
                            ...
                            <div style='color:#16a34a; font-size:1.1rem; font-weight:700;'>{int(skill_scores[j_idx]*100)}%</div>
                            <div style='color:#64748b; font-size:0.75rem; text-transform:uppercase;
                                        font-weight:600; margin-top:0.1rem;'>Skills</div>
                        </div>
                        <div style='background:#f8fafc; border:1px solid #e2e8f0; border-radius:8px;
                                    padding:0.6rem; text-align:center;'>
                            <div style='color:#0891b2; font-size:1.1rem; font-weight:700;'>{int(edu_scores[j_idx]*100)}%</div>
                            <div style='color:#64748b; font-size:0.75rem; text-transform:uppercase;
                                        font-weight:600; margin-top:0.1rem;'>Education</div>
                        </div>
                        <div style='background:#f8fafc; border:1px solid #e2e8f0; border-radius:8px;
                                    padding:0.6rem; text-align:center;'>
                            <div style='color:#4f46e5; font-size:1.1rem; font-weight:700;'>{int(cos_scores[j_idx]*100)}%</div>
                            <div style='color:#64748b; font-size:0.75rem; text-transform:uppercase;
...
# ══════════════════════════════════════════════════════════════════════════
    ...
    with col1:
        ...
        fig.add_vline(x=top1['Final_Score'].mean(), line_dash='dash',
                      ...
                      annotation_font_color='#d97706', annotation_font_size=13)
    ...
    if all_skills:
        ...
        fig = px.bar(skill_df, x='Count', y='Skill', orientation='h',
                     color='Count',
                     color_continuous_scale=[[0,'#e0e7ff'],[0.5,'#4f46e5'],[1,'#3730a3']],
...
# ══════════════════════════════════════════════════════════════════════════
    ...
    for title, desc in steps:
        ...
        <div class='match-card'>
            <div style='font-family:Space Grotesk,sans-serif; font-weight:700;
                        color:#4f46e5; font-size:1.1rem; margin-bottom:0.5rem;'>{title}</div>
            <div style='color:#334155; font-size:1rem; line-height:1.85;
    ...
    <div class='info-box'>
        <table style='width:100%; border-collapse:collapse; font-size:1rem;'>
            <tr style='border-bottom:2px solid #e2e8f0;'>
                <th style='padding:0.8rem 0.6rem; text-align:left; color:#4f46e5;'>Component</th>
                <th style='padding:0.8rem 0.6rem; text-align:center; color:#4f46e5;'>Weight</th>
                <th style='padding:0.8rem 0.6rem; text-align:left; color:#4f46e5;'>What it measures</th>
            </tr>
            <tr style='border-bottom:1px solid #f1f5f9;'>
                <td style='padding:0.8rem 0.6rem; color:#0f172a;'>Skill Overlap</td>
                <td style='padding:0.8rem 0.6rem; text-align:center; color:#16a34a; font-weight:700; font-size:1.1rem;'>40%</td>
                <td style='padding:0.8rem 0.6rem; color:#475569;'>Fraction of job's required skills found in your resume</td>
            </tr>
            <tr style='border-bottom:1px solid #f1f5f9;'>
                <td style='padding:0.8rem 0.6rem; color:#0f172a;'>Education Match</td>
                <td style='padding:0.8rem 0.6rem; text-align:center; color:#0891b2; font-weight:700; font-size:1.1rem;'>20%</td>
                <td style='padding:0.8rem 0.6rem; color:#475569;'>Your education level vs job requirement</td>
            </tr>
            <tr style='border-bottom:1px solid #f1f5f9;'>
                <td style='padding:0.8rem 0.6rem; color:#0f172a;'>Experience Match</td>
                <td style='padding:0.8rem 0.6rem; text-align:center; color:#4f46e5; font-weight:700; font-size:1.1rem;'>20%</td>
                <td style='padding:0.8rem 0.6rem; color:#475569;'>Entry / Mid / Senior level alignment</td>
            </tr>
            <tr>
                <td style='padding:0.8rem 0.6rem; color:#0f172a;'>Cosine Similarity</td>
                <td style='padding:0.8rem 0.6rem; text-align:center; color:#d97706; font-weight:700; font-size:1.1rem;'>20%</td>
                <td style='padding:0.8rem 0.6rem; color:#475569;'>Semantic meaning match via BERT embeddings</td>
            </tr>
        </table>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div class='info-box'>
        <div style='color:#334155; font-size:1rem; line-height:2;'>
            <b style='color:#4f46e5;'>Precision@5</b> measures how many of the top 5
            recommended jobs are actually relevant to the resume's career field.<br><br>
            <b style='color:#4f46e5;'>Formula:</b> Precision@5 = Relevant jobs in top 5 ÷ 5<br><br>
            <b style='color:#16a34a; font-size:1.1rem;'>BERT Result: 70.5%</b> — meaning on average,
